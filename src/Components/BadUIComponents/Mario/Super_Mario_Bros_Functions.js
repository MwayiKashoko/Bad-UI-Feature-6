...
// Helper function to check if image is loaded before drawing
			...
			if (this.vineStructure != null) {
				...
				for (let i = 0; i < this.vineStructure; i++) {
					if (this.vineY - i * 40 < this.drawnY) {
						const vineImg = i == this.vineStructure - 1 ? vine1 : vine2;
						if (isImageLoaded(vineImg)) {
							graphics.drawImage(vineImg, Math.round(this.drawnX), Math.round(this.vineY - i * 40), this.width, this.height);
						}
					}
				}
			}
