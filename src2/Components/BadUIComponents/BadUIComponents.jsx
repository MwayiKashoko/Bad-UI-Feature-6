...
export const SimpleMathQuestion = ({ user }) => {
    ...
    */
    ...
    const [text, setText] = useState("Could not verify that you are a human. Please solve the following math problem to prove you're not a human");
...
export const TetrisGame = ({ user, ui }) => {
    ...
    useEffect(() => {
        switch (ui.uiFeature) {
            ...
            case "TetrisFast":
            case "TetrisMarathon":
                setText("Could not verify that you're a human. Please beat the Tetris level to verify you're not a robot.");
                break;
            default:
                setText("null");
                break;
